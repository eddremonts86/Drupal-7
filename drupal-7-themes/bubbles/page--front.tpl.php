...
<header>
    <div class="background-wrap">
        <video id="video-bg-elem" preload="auto" autoplay="true" loop="loop" muted="muted">
            <source src="/bubbles/sites/all/themes/bubbles/img/video/video4.mp4" type="video/mp4">
            Video not supported
        </video>
    </div>
...
<section class="bg-user" id="about">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <img src="/bubbles/sites/all/themes/bubbles/img/bubbles/trabajadores.jpg" width="200" height=auto>
            </div>
