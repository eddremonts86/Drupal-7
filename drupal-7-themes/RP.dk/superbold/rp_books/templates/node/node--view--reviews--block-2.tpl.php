...
@$title = $node->field_bonuscode_cta['und'][0]['title'];
 //var_dump($_SESSION["site_type"]);
...
<article class="hero-item">
    <div class="hero-item-image">
        <a href="<?php print $img_url_img ?>"> <?php print render($content['field_image']) ?></a>
    </div>
        ...
        <?php if (@$content['field_bonuscode_cta']) {?>
            <div class="row cta_head">
                ...
                <div class="col-xs-10  col-md-4 cta_btn">
                    <span class='blur'>
                         <a href="<?php print $img_url_img ?>" target="_blank" rel="nofollow" class="button green"><?php print $title ?></a>
                    </span>
