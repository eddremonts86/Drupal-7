    ...
    <div class="back_box" style="padding: 12px">
        ...
        <div class="back_body">
            ...
            <div>
                ...
                <a class="BET_rew" target="_blank" href="<?php echo $field_bet_button; ?>" class="button">Bet Now</a>
                <a class="Read_rew" href="<?php echo $path_alias; ?>" class="button_rew">Læs Anmeldelse</a>
            </div>
        </div>
    </div>
</div>
