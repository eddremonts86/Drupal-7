  ...
  if (!empty($breadcrumb)) {
    ...
    if(isset($node) && $node ){
      ...
      if($node->type =='article'){
        ...
        $breadcrumbs .= '<li class="active"><a href="/nyheter">' . $view_title. '</a></li>';
        //$breadcrumbs .= '<li><a href=/'.$tags_url.'>' .$tags. '</a></li>';
      }
        ...
        $view_title = $view->display['page']->display_options['menu']['title'];
        $view_path = $view->display['page']->display_options['path'];
        $breadcrumbs .= '<li class="active"><a href="/tips">' . $view_title. '</a></li>';
      }
        ...
        $view_title = $view->display['page']->display_options['menu']['title'];
        $view_path = $view->display['page']->display_options['path'];
        $breadcrumbs .= '<li class="active"><a href="/blogg">' . $view_title. '</a></li>';
      }
        ...
        $breadcrumbs .= '<li class="active"><a href="/bookmaker-anmeldelse">' . $view_title. '</a></li>';
      }
    }
