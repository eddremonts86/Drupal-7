                      ...
                      <article class="featured">
                          <main>
                              <div class="thumbnail"><a
                                          href="<?php echo wsn_get_link($node); ?>"><img
                                              src="<?php echo wsn_get_image($node, 'horizontal_crop_image_big'); ?>"
                                              alt="<?php echo wsn_get_image_alt($node, 'horizontal_crop_image_big'); ?>"></a>
                              </div>
                              <div class="caption <?php echo $sponsor_class ?>">
                                  ...
                                  <h3>
                                      <a href="<?php echo wsn_get_link($node); ?>"><?php echo $node->title; ?></a>
                                  </h3>
                                <?php echo $sponsor ?>
