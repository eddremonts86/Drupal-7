...
<html lang="nb-NO">
  <head>
      ...
      <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
          ...
          })(window,document,'script','dataLayer','GTM-TR2XDRZ');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TR2XDRZ" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <?php if(drupal_is_front_page()){ ?><h1><?php } ?>
              <a href="/" class="navbar-brand"><img src="<?php echo $path_to_theme ?>/files/img/sportal-no-logo.png" alt="Sportal.no"></a>
            <?php if(drupal_is_front_page()){ ?></h1><?php } ?>
          </div>
