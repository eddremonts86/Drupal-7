...
<div class="row main-article <?php echo $class_status ?>">
    <header>
        <figure>
            ...
            <div class="caption">
                <div class="label label-default"><?php  print t("NYHEDER")//echo $type_node;?></div>
            </div>
        </figure>
...
<aside class="info-author-content">
    <div class="main">
        ...
        <div class="data">
            ...
            <p><?php /*print t("Antal nyhetsartiklar");*/?> : <?php /*echo get_number_articles_author($node->uid,'article'); */?></p>
        </div>
    </div>
</aside>
-->
