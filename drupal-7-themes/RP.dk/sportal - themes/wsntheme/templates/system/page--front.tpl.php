              ...
              <article class="featured">
                <main>
                  ...
                  <div class="caption <?php echo $sponsor_class ?>">
                    <div class="label label-default test <?php echo wsn_get_type_css( $node->type); ?>"><?php print t("Tip"); ?></div>
              ...
              <div class="row">
                ...
                <article>
                  <main>
                    ...
                    <div class="caption <?php echo $sponsor_class ?>">
                      <div class="label label-default <?php echo wsn_get_type_css( $node->type); ?>"><?php print t("Nyheter"); ?></div>
                      <h3> <a href="<?php echo wsn_get_link($node); ?>"><?php echo $node->title; ?></a></h3>
                      <?php echo $sponsor ?>
                      <p><?php echo wsn_get_summary($node); ?></p>
                      <time><?php echo wsn_get_date($node); ?></time>
                ...
                <article>
                   <main>
                    <div class="thumbnail"><a href="<?php echo wsn_get_link($node); ?>"><img src="<?php echo wsn_get_image($node);?>"  alt="<?php echo wsn_get_image_alt($node,'horizontal_crop_image_big');?>"></a></div>
                    <div class="caption <?php echo $sponsor_class ?>">
                      <div class="label label-default <?php echo wsn_get_type_css( $node->type); ?>"><?php print t("Tip"); ?></div>
                      <h3> <a href="<?php echo wsn_get_link($node); ?>"><?php echo $node->title; ?></a></h3>
                      <?php echo $sponsor ?>
                      <p><?php echo wsn_get_summary($node); ?></p>
                      <time><?php echo wsn_get_date($node); ?></time>
