  ...
  <header>
    ...
    <aside class="info-bookmarker">
      ...
      <?php if($field_players_from_denmark_accep =='yes'){ ?>
        <div class="info-country"><img src="<?php echo $path_to_theme ?>/files/img/ico-flag.png" alt=""><?php print t("Players from Denmark accepted "); ?></div>
      <?php } ?>
    </aside>
  </header>
  <main>
    ...
    <nav class="steps">
      <ul>
        <li><?php print t("Go to the website"); ?></li>
        <li><?php print t("Create a user"); ?></li>
        <li><?php print t("Start betting"); ?></li>
    ...
    <div class="cms cw-btn-play"><strong>Get your bonus!</strong><a href="<?php echo $field_affiliate_link ?>" class="btn btn-play"  target="_blank" rel="nofollow"><?php print t("Play"); ?></a></div>
  </main>
</div>
