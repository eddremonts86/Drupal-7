  ...
  <main class="<?php echo $class_sponsor ?>">
    ...
    <aside class="info-tip">
      ...
      <div class="col">
        ...
        <div class="play"><a href="<?php echo $bookmaker_link[0]['value'] ?>" rel="nofollow" target="_blank" class="btn btn-play"><?php print t("Play"); ?></a></div>
        <?php } ?>
      </div>
    </aside>
    <div class="cms"> 
    ...
    <?php if($field_bookmaker){ ?>
      <div class="cms cw-btn-play"><a href="<?php echo $bookmaker_link[0]['value'] ?>" class="btn btn-play"  target="_blank" rel="nofollow"><?php print t("Play"); ?></a></div>
    <?php } ?>
  </main>
...
<aside class="info-author-content">
    <div class="main">
      ...
      <div class="data">
        ...
        <p><?php print t("Number of tips");?> : <?php echo get_number_articles_author($node->uid,'tip'); ?></p>
      </div>
    </div>
  </aside>
