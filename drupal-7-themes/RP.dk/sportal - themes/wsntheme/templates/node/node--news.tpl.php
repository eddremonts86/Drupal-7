...
<div class="row main-article <?php echo $class_status ?>">
  <header>
    <figure><img src="<?php echo $field_image ?>"  alt="<?php echo $field_image_alt ;?>">
      ...
      <div class="caption">
        <div class="label label-default"><?php echo $type_node;?> jkfhbj</div>
      </div>
    </figure>
    ...
    <aside class="user-info-detail">
      <div>
        <figure><img src="<?php echo $picture ?>"><strong><?php echo $user_name;?></strong></figure>
  ...
  <main class="<?php echo $class_sponsor ?>">
    ...
    <?php if($sponsor && $sponsor_active){ ?>
      <strong class="sp"><em style="color: <?php echo $sponsor_color;?>;"><?php print t("Sponsored by");?> </em>
...
<aside class="info-author-content">
    <div class="main">
      <figure><img src="<?php echo $picture ?>"></figure>
      <div class="data">
        <h2><?php echo $user_name;?></h2>
        <p><?php print t("Numbers of news articles");?> : <?php echo get_number_articles_author($node->uid,'new'); ?></p>
      </div>
    </div>
  </aside>
