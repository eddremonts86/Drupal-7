          ...
          <div class="row _col-main">
            <section class="list-tops">
              ...
              <article class="featured">
                <div>
                  <div class="thumbnail">
			<a href="<?php echo wsn_get_link($node,'main_image_content'); ?>">
			  <img src="<?php echo wsn_get_image($node,'main_image_content');?>"  alt="<?php echo wsn_get_image_alt($node,'main_image_content');?>">
		        </a>
		</div>
            ...
            <?php if(isset($node_queues[4])) { $node = $node_queues[4];
              ...
              ?>
                <article>
                    <div>
                        <div class="thumbnail">
                            <a href="<?php echo wsn_get_link($node); ?>">
                             <img src="<?php echo wsn_get_image($node,'horizontal_crop_image_big');?>"  alt="<?php echo wsn_get_image_alt($node,'horizontal_crop_image_big');?>">
                            </a>
                        </div>
                        <div class="caption <?php echo $sponsor_class ?>">
                            <div class="label label-default <?php echo wsn_get_type_css( $node->type); ?>"><?php echo wsn_get_type_text( $node->type); ?></div>
          ...
          <div class="col-side">
            <section class="list-med">
              ...
              <article>
                <div>
                    <div class="thumbnail">
                        <a href="<?php echo wsn_get_link($node); ?>"><img src="<?php echo wsn_get_image($node);?>"  alt="<?php echo wsn_get_image_alt($node,'horizontal_crop_image_big');?>"></a>
                    </div>
                    <div class="caption <?php echo $sponsor_class ?>">
                      <div class="label label-default <?php echo wsn_get_type_css( $node->type); ?>"><?php echo wsn_get_type_text( $node->type); ?></div>
                      <h3> <a href="<?php echo wsn_get_link($node); ?>"><?php echo $node->title; ?></a></h3>
        ...
        <div class="row">
          <section class="list-last">
            ...
            <article>
             ...
             <?php } ?>
            <?php if(isset($node_queues[8])) { $node = $node_queues[8];
              $sponsor_class = '';
              $sponsor = wsn_get_sponsor($node);
              if($sponsor){
                $sponsor_class = 'sp';
