    ...
    <h1><?php echo $title;?></h1>
     ...
     <div class="row general" >
        <div class="general_son_sponsor general_son col-lg-3  col-md-4 text-style">
            <span class="badge">1</span> Visit Bet365
        </div>
        ...
        <div class="general_son col-lg-3  col-md-12 btn_cta">
            <a class="btn btn-danger btn-lg" href="http://www.bet365.com/dl/~offer?affiliate=365_546772" rel="nofollow" target="_blank" role="button">START HERE</a>
        </div>
    </div>
