                    ...
                    p._pcq.push(['_currentTime',Date.now()]);
                            s=u.createElement('script');
                                    s.type='text/javascript';
                                            s.async=true;
                                                    s.src='https://cdn.pushcrew.com/js/e9dc09b1c9f14e6b39076eeb204b8d64.js';
    ...
    <footer>
        <div class="row navs">
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <section class="se_adv"><p id="Underage">Underage Policy</p></section>
            </div>
...
<div class="under under-age-new">
    <h3>Advertiser Disclosure</h3>
    <hr>
    <p>This site is supported by payment from some of the operators who are ranked on the site and the payment can
        impact the ranking of
        the sites listed.</p>
    <p>The reviews might be a promotional features and the site will be paid by some of the providers to provide the
        following positive
        reviews about them – the reviews is not provided by an independent consumer.</p>
</div>
<div class="under under-age-Underage">
    <h3>Underage Policy</h3>
    <hr>
    <p>All Sportbooks listed at WSN.com are licensed in the UK and requires you to be at least 18 years of age.
        Underage gambling is an offence.
        We also recommend that you gamble only in moderation and recreationally.
        WSN.com supports responsible gambling.
        For more info visit <a href="http://www.gamcare.org.uk/" rel="nofollow">GamCare</a> &
        <a href="http://www.gambleaware.co.uk/" rel="nofollow">Gamble Aware</a></p>
</div>
