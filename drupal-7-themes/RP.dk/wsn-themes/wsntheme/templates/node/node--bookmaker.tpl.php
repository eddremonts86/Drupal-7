...
<div class="row main-article main-bookmarker">
  ...
  <main>
    ...
    <div class="cms cw-btn-play"><strong>Get your bonus!</strong><a href="<?php echo $field_affiliate_link ?>" class="btn btn-play"  target="_blank" rel="nofollow">Bet now</a></div>
  </main>
</div>
